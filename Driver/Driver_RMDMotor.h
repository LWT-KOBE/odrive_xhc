...
1. 打开 odrivetool 命令窗口。
2. 配置 Axis0 的 CAN Node ID 为 2。
...
#define ODRIVE_ID 				0x010	//配置 Axis0 的 CAN Node ID 为 2
...
extern void RMDLMotorReadData(CanRxMsg* CanRevData,RMDLCanDataRecv_t* Spetsnaz);
