...
BSP_SPI_TypeDef ICM42605_SPI_Base = ICM42605_SPI_DEFAULT;
BSP_SPI_TypeDef *ICM42605_SPI = &ICM42605_SPI_Base;

icm42605Struct_t icm42605Data;
...
uint16_t brustReadIcm42605(void) {
    ...
    if(dataSum != 0) {
		...
		digitalIncreasing(&icm42605Data.ImuError.errorCount);

		//角速度正常使能	
		//wiredTransTypeSwitch(TRANS_ADD_IMU_SENSOR, ENABLE);
	
    }
    return IcmDataCNTR_Check();
}
...
//	icm42605Data.rawGyo[0] = (float)meanRecursiveFilter(icm42605Data.gyroscope[0].s16_temp,0);
//	icm42605Data.rawGyo[1] = (float)meanRecursiveFilter(icm42605Data.gyroscope[1].s16_temp,1);
//	icm42605Data.rawGyo[2] = (float)meanRecursiveFilter(icm42605Data.gyroscope[2].s16_temp,2);
//    
//	icm42605Data.gyo[0] = icm42605Data.rawGyo[0] * icm42605Data.gyroScale;
//	icm42605Data.gyo[1] = icm42605Data.rawGyo[1] * icm42605Data.gyroScale;
//	icm42605Data.gyo[2] = icm42605Data.rawGyo[2] * icm42605Data.gyroScale;    
//    
//	icm42605Data.rawAcc[0] = (float)LowPass_Filter(icm42605Data.acceleration[0].s16_temp,&sensorRotate.lowPassFilterData[ACCEL_X_1000HZ_LOWPASS]);
//	icm42605Data.rawAcc[1] = (float)LowPass_Filter(icm42605Data.acceleration[1].s16_temp,&sensorRotate.lowPassFilterData[ACCEL_Y_1000HZ_LOWPASS]);
//	icm42605Data.rawAcc[2] = (float)LowPass_Filter(icm42605Data.acceleration[2].s16_temp,&sensorRotate.lowPassFilterData[ACCEL_Z_1000HZ_LOWPASS]);

//	icm42605Data.acc[0] = icm42605Data.rawAcc[0] * icm42605Data.accelScale;
//	icm42605Data.acc[1] = icm42605Data.rawAcc[1] * icm42605Data.accelScale;
//	icm42605Data.acc[2] = icm42605Data.rawAcc[2] * icm42605Data.accelScale;       
