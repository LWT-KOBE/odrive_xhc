...
///////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		//ANO_DT_Send_Status(slaveSensorData.roll.float_temp,slaveSensorData.pitch.float_temp,slaveSensorData.yaw.float_temp,0,0,0/*wcz_hei_fus.out,(flag.flight_mode+1),flag.unlock_sta*/);	
		
		ANO_DT_Send_Status(AQ_ROLL,AQ_PITCH,AQ_YAW,0,0,0/*wcz_hei_fus.out,(flag.flight_mode+1),flag.unlock_sta*/);	
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
//		ANO_DT_Send_Senser( slaveSensorData.normalizedAcc[0].float_temp,\
//                            slaveSensorData.normalizedAcc[1].float_temp,\
//                            slaveSensorData.normalizedAcc[2].float_temp,\
//                            slaveSensorData.normalizedGyo[0].float_temp,\
//                            slaveSensorData.normalizedGyo[1].float_temp,\
//                            slaveSensorData.normalizedGyo[2].float_temp,\
//                            slaveSensorData.normalizedMag[0].float_temp,\
//                            slaveSensorData.normalizedMag[1].float_temp,\
//                            slaveSensorData.normalizedMag[2].float_temp);
		
		ANO_DT_Send_Senser( IMU_ACCX,\
                            IMU_ACCY,\
                            IMU_ACCZ,\
                            IMU_RATEX,\
                            IMU_RATEY,\
...
//		ANO_DT_Send_Senser(controlData.attitude.pitch*10,controlData.attitude.yaw*10,controlData.attitude.roll*10,
//											 0,0,0,
//											 0,0,0);         
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
		ANO_DT_Send_Senser2(0,0,imuSensorData.temp.float_temp*10);//原始数据
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
//			}
//		}
//		ANO_DT_Send_RCData(remoteData.dbus.dbusData.CH3,\
//                            remoteData.dbus.dbusData.CH2,\
//                            remoteData.dbus.dbusData.CH1,\
//                            remoteData.dbus.dbusData.CH0,\
//                            remoteData.dbus.dbusData.S1,\
//                            remoteData.dbus.dbusData.S2,\
//                            0,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////	
...
void wirelessInit(void){
	...
	getsupervisorData()->taskEvent[WIRELESS_TASK] = xTaskCreate(dataTransportTask,\
                                                                "DATATRANS",\
                                                                WIRELESS_STACK_SIZE,\
                                                                NULL,WIRELESS_PRIORITY,\
                                                                &wirelessData.xHandleTask);
}
