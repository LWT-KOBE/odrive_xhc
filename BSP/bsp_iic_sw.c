...
***************************************************
*/
void BSP_IIC_SW_Init(BSP_GPIOSource_TypeDef* BSP_IIC_SCL_GPIO,BSP_GPIOSource_TypeDef* BSP_IIC_SDA_GPIO){
	BSP_GPIO_Init(BSP_IIC_SCL_GPIO, GPIO_Mode_Out_PP);
	BSP_GPIO_Init(BSP_IIC_SDA_GPIO, GPIO_Mode_Out_PP);
	IIC_SCL=1;
	IIC_SDA=1;
}
