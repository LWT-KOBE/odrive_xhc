...
//uint8_t *Array_USART1_RX;
//uint8_t *Array_USART2_RX;
//uint8_t *Array_USART3_RX;
//uint8_t *Array_UART4_RX ;
//uint8_t *Array_UART5_RX ;
//uint8_t *Array_USART6_RX;
//uint8_t *Array_UART7_RX ;
//uint8_t *Array_UART8_RX ;

//uint8_t *Array_USART1_TX;
//uint8_t *Array_USART2_TX;
//uint8_t *Array_USART3_TX;
//uint8_t *Array_UART4_TX ;
//uint8_t *Array_UART5_TX ;
//uint8_t *Array_USART6_TX;
//uint8_t *Array_UART7_TX ;
//uint8_t *Array_UART8_TX ;
...
//	uint32_t marAddr = NULL;
//	if(USARTx == USART1){
//		Array_USART1_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART1_TX;
//	}
//	else if(USARTx == USART2){
//		Array_USART2_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART2_TX;
//	}
//	else if(USARTx == USART3){
//		Array_USART3_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART3_TX;
//	}
//	else if(USARTx == UART4){
//		Array_UART4_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART4_TX;
//	}
//	else if(USARTx == UART5){
//		Array_UART5_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART5_TX;
//	}
//	else if(USARTx == USART6){
//		Array_USART6_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART6_TX;
//	}
//	else if(USARTx == UART7){
//		Array_UART7_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART7_TX;
//	}
//	else if(USARTx == UART8){
//		Array_UART8_TX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART8_TX;
//	}
//	return marAddr;
//}
///*
...
//	uint32_t marAddr = NULL;
//	if(USARTx == USART1){
//		Array_USART1_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART1_RX;
//	}
//	else if(USARTx == USART2){
//		Array_USART2_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART2_RX;
//	}
//	else if(USARTx == USART3){
//		Array_USART3_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART3_RX;
//	}
//	else if(USARTx == UART4){
//		Array_UART4_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART4_RX;
//	}
//	else if(USARTx == UART5){
//		Array_UART5_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART5_RX;
//	}
//	else if(USARTx == USART6){
//		Array_USART6_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_USART6_RX;
//	}
//	else if(USARTx == UART7){
//		Array_UART7_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART7_RX;
//	}
//	else if(USARTx == UART8){
//		Array_UART8_RX = (uint8_t*)aqCalloc(len,sizeof(uint8_t));
//		marAddr = (uint32_t)Array_UART8_RX;
//	}
//	return marAddr;
//}
...
//	else if(USARTx == UART7)
//		ArrayRX = (uint32_t)Array_UART7_RX;
//	else if(USARTx == UART8)
//		ArrayRX = (uint32_t)Array_UART8_RX;
//	return ArrayRX;	
//}
...
//	else if(USARTx == UART7)
//		Length = Length_UART7_RX_Buff;
//	else if(USARTx == UART8)
//		Length = Length_UART8_RX_Buff;
//	
//	return Length;	
//}
...
//	else if(USARTx == UART7)
//		ArrayTX = (uint32_t)Array_UART7_TX;
//	else if(USARTx == UART8)
//		ArrayTX = (uint32_t)Array_UART8_TX;
//	
//	return ArrayTX;	
//}
...
//	else if(USARTx == UART7)
//		Length = Length_UART7_TX_Buff;
//	else if(USARTx == UART8)
//		Length = Length_UART8_TX_Buff;
//	
//	return Length;	
//}
...
//void BSP_USART_TX_DMA_Init(BSP_USART_TypeDef *BSP_USARTx){
//	uint32_t ndtr = USART_TO_LengthArrayTX(BSP_USARTx->USARTx);
//	BSP_DMA_TypeDef *BSP_DMA_Streamx_chx = USART_TO_BSP_DMA_Streamx_chx(BSP_USARTx->USARTx,USART_DMAReq_Tx);
//	BSP_DMA_TX_Init(BSP_DMA_Streamx_chx,BSP_USARTx->USARTx,(uint32_t)&BSP_USARTx->USARTx->DR,ndtr);
//	USART_DMACmd(BSP_USARTx->USARTx,USART_DMAReq_Tx,ENABLE);	//开启串口DMA发送
//}
...
//	BSP_DMA_RX_Init(BSP_DMA_Streamx_chx,BSP_USARTx->USARTx,(uint32_t)&BSP_USARTx->USARTx->DR,ndtr);
//	USART_DMACmd(BSP_USARTx->USARTx,USART_DMAReq_Rx,ENABLE);	//开启串口DMA接收
//}
...
//	else if(USARTx == UART7)
//		retry = BSP_UART7_DMA_SendData(Array, len);
//	else if(USARTx == UART8)
//		retry = BSP_UART8_DMA_SendData(Array, len);
//	return retry;
//}
